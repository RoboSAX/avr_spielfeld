...
#define YEAR_ACTION(YEAR)                                                   \
    ...
    uint8_t       gamemode_start_##YEAR(uint8_t              gameMode,      \
    ...
    struct Points gamemode_points_##YEAR(uint8_t mode);                     \
                                                                            \
    void gamemode_to_display_##YEAR(uint8_t         gameMode,               \
                                    uint8_t const** displayOut1,            \
...
#define YEAR_ACTION(YEAR) GameOfYear##YEAR,
  enum eAvailibleYears {
      GameOfCurrentYear,
      ProcessYears NumberOfAvailibleYears
  };
